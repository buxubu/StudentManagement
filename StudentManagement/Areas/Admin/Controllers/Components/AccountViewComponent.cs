...
namespace StudentManagement.Areas.Admin.Controllers.Components
{
    public class AccountViewComponent : ViewComponent
    {
        ...
        public AccountViewComponent(DbStuManageContext db, IMemoryCache memoryCache, IAccount accountService)
        {
            _db = db;
